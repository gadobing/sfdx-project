...
import { OMNIDEF } from './caseManagementCaseEnglish_def.js';
import tmpl from './caseManagementCaseEnglish.html';
import tmpl_nds from './caseManagementCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseManagementCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
